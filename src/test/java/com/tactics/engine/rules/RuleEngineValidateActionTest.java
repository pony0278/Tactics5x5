...
class RuleEngineValidateActionTest {
    ...
    class MoveValidation {
        ...
        void m2_moveOutOfBoardNegative() {
            Unit u1_p1 = new Unit("u1_p1", p1, 10, 3, new Position(0, 0), true);
            GameState state = new GameState(board, Collections.singletonList(u1_p1), p1, false, null);
        ...
        void m3_moveOutOfBoardMax() {
            Unit u1_p1 = new Unit("u1_p1", p1, 10, 3, new Position(4, 4), true);
            GameState state = new GameState(board, Collections.singletonList(u1_p1), p1, false, null);
        ...
        void m6_moveIntoOccupiedTile() {
            Unit u1_p1 = new Unit("u1_p1", p1, 10, 3, new Position(1, 1), true);
            Unit u2_p1 = new Unit("u2_p1", p1, 10, 3, new Position(1, 2), true);
        ...
        void m7_moveWithDeadUnit() {
            Unit u1_p1 = new Unit("u1_p1", p1, 0, 3, new Position(1, 1), false);
            GameState state = new GameState(board, Collections.singletonList(u1_p1), p1, false, null);
    ...
    class AttackValidation {
        ...
        void a2_attackOutOfRange() {
            Unit u1_p1 = new Unit("u1_p1", p1, 10, 3, new Position(1, 1), true);
            Unit u1_p2 = new Unit("u1_p2", p2, 10, 3, new Position(1, 3), true);
            GameState state = new GameState(board, Arrays.asList(u1_p1, u1_p2), p1, false, null);
        ...
        void a6_attackDeadTarget() {
            Unit u1_p1 = new Unit("u1_p1", p1, 10, 3, new Position(1, 1), true);
            Unit u1_p2 = new Unit("u1_p2", p2, 0, 3, new Position(1, 2), false);
            GameState state = new GameState(board, Arrays.asList(u1_p1, u1_p2), p1, false, null);
        ...
        void a9_attackAmbiguousAttacker() {
            Unit u1_p1 = new Unit("u1_p1", p1, 10, 3, new Position(1, 1), true);
            Unit u2_p1 = new Unit("u2_p1", p1, 10, 3, new Position(1, 3), true);
            Unit u1_p2 = new Unit("u1_p2", p2, 10, 3, new Position(1, 2), true);
    ...
    class MoveAndAttackValidation {
        ...
        void ma2_moveAndAttackIllegalMoveStep() {
            Unit u1_p1 = new Unit("u1_p1", p1, 10, 3, new Position(1, 1), true);
            Unit u1_p2 = new Unit("u1_p2", p2, 10, 3, new Position(1, 4), true);
            GameState state = new GameState(board, Arrays.asList(u1_p1, u1_p2), p1, false, null);
        ...
        void ma6_moveAndAttackAmbiguousAttacker() {
            ...
            Unit u1_p1 = new Unit("u1_p1", p1, 10, 3, new Position(0, 2), true);
        ...
        void ma8_moveAndAttackDeadTarget() {
            Unit u1_p1 = new Unit("u1_p1", p1, 10, 3, new Position(1, 1), true);
            Unit u1_p2 = new Unit("u1_p2", p2, 0, 3, new Position(2, 2), false);
            GameState state = new GameState(board, Arrays.asList(u1_p1, u1_p2), p1, false, null);
    ...
    class EdgeCases {
        ...
        void e_moveAndAttackOutOfBoard() {
            Unit u1_p1 = new Unit("u1_p1", p1, 10, 3, new Position(4, 4), true);
            Unit u1_p2 = new Unit("u1_p2", p2, 10, 3, new Position(4, 3), true);
            GameState state = new GameState(board, Arrays.asList(u1_p1, u1_p2), p1, false, null);
